...
"""
Video Analyzer Agent for GPT-4o-mini
기준 시점 탐지와 행동 단계 분석을 통합하여 수행합니다. (GPT-4o-mini)
"""
...
class VideoAnalyzerAgent4oMini:
    """
    비디오 분석 통합 Agent (GPT-4o-mini)
    ...
    def __init__(self, mllm, video_processor: VideoProcessorAgent):
        ...
        self.name = "VideoAnalyzerAgent4oMini"
    ...
    def process(self, state: VideoAnalysisState) -> VideoAnalysisState:
        ...
        try:
            ...
            state["agent_logs"].append({
                ...
                "message": "비디오 분석 시작 (기준 시점 탐지 + 행동 분석) - GPT-4o-mini"
            })
            ...
            state["reference_times_4o_mini"]["inhalerIN"] = ref_time_in
            state["q_answers_accumulated_4o_mini"]["inhalerIN"] = q_answers_in
            ...
            state["reference_times_4o_mini"]["faceONinhaler"] = ref_time_face
            state["q_answers_accumulated_4o_mini"]["faceONinhaler"] = q_answers_face
            ...
            state["reference_times_4o_mini"]["inhalerOUT"] = ref_time_out
            state["q_answers_accumulated_4o_mini"]["inhalerOUT"] = q_answers_out
            ...
            state["promptbank_data_4o_mini"] = promptbank_data
            ...
            if promptbank_data:
                ...
                state["action_analysis_results_4o_mini"] = action_summary
            ...
            state["agent_logs"].append({
                "agent": self.name,
                "action": "complete",
                "message": "비디오 분석 완료 (기준 시점 탐지 + 행동 분석) - GPT-4o-mini"
            })
...
Q1: {self.promptbank.check_action_step_common['sit_stand']['action']}
...
Q1. {self.promptbank.check_action_step_common['sit_stand']['action']}
Q2. {self.promptbank.check_action_step_common['remove_cover']['action']}
Q3. {self.promptbank.check_action_step_common['inspect_mouthpiece']['action']}
Q4. {self.promptbank.check_action_step_common['shake_inhaler']['action']}
Q5. {self.promptbank.check_action_step_common['hold_inhaler']['action']}
Q6. {self.promptbank.check_action_step_common['load_dose']['action']}
Q7. {self.promptbank.check_action_step_common['exhale_before']['action']}
Q8. {self.promptbank.check_action_step_common['seal_lips']['action']}
...
Q1. {self.promptbank.check_action_step_common['seal_lips']['action']}
Q2. {self.promptbank.check_action_step_common['inhale_deeply']['action']}
Q3. {self.promptbank.check_action_step_common['remove_inhaler']['action']}
Q4. {self.promptbank.check_action_step_common['hold_breath']['action']}
Q5. {self.promptbank.check_action_step_common['exhale_after']['action']}
Q6. {self.promptbank.check_action_step_common['replace_cover']['action']}
